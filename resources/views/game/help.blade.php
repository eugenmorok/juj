    ...
    <div class="space-y-8">
        ...
        <section class="grid gap-6 lg:grid-cols-2">
            ...
            <article class="rounded-md border border-zinc-800 bg-zinc-900 p-5">
                ...
                <div class="mt-4 space-y-3 text-sm text-zinc-300">
                    <p>Система подбирает соперника по уровню и power score. Если игроков мало, подключаются боты.</p>
                    <p>Бой считается сервером сразу, а на странице результата показывается пошаговый лог.</p>
