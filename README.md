...
Текущие feature-тесты покрывают регистрацию, создание сущности, бюджет 100 очков, магазин, инвентарь, расходники, экипировку, подбор соперников, вызовы, пошаговый бой, live-состояние боя, replay, награды, повышение уровня, ботов, админ-доступ и сквозной MVP-цикл.
