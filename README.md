...
- магазин предметов, услуг, расширения инвентаря и продажа предметов за токены;
- арена с подбором соперников, вызовами, пошаговым боем, live polling, replay-таймлайном, логом боя, наградами и повышением уровня;
- админский список боев с быстрым открытием боя, Replay и безопасной симуляцией без начисления наград;
- админские инструменты игроков: просмотр экономики, выдача токенов и предметов;
...
Текущие feature-тесты покрывают регистрацию, создание сущности, бюджет 100 очков, магазин, продажу предметов, инвентарь, расходники, экипировку, подбор соперников, вызовы, пошаговый бой, live-состояние боя, replay, награды, повышение уровня, ботов, админ-доступ, админские экономические выдачи и сквозной MVP-цикл.
